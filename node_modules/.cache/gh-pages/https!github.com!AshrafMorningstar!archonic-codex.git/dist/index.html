...
<html lang="en">
  <head>
    ...
    <title>Archonic Codex 🌌 | Universal Knowledge Engine</title>
    <meta name="description" content="Ashraf Morningstar's Neuromorphic Portfolio" />
    ...
    <style>
      ...
      ::-webkit-scrollbar-thumb {
        background: linear-gradient(180deg, var(--neuro-purple), var(--quantum-glow));
        border-radius: 3px;
      }
  ...
  <script type="importmap">
{
  ...
  <script type="module" crossorigin src="/assets/index-8CW-UySs.js"></script>
  <link rel="stylesheet" crossorigin href="/assets/index-CTaMZg68.css">
  <link rel="stylesheet" href="../../automations/premium_theme.css">
<style>
:root {
    --primary: #00f2fe;
    --secondary: #4facfe;
...
* {
  ...
  <body class="h-screen w-screen overflow-hidden transition-colors duration-500">
    <div id="root"></div>
</body>
</html>